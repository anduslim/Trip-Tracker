...
- Multi-city itinerary search via Amadeus `flight_offers_search.post` and SerpApi `type=3`
- Price-analysis context from Amadeus `analytics.itinerary_price_metrics` shown alongside search results
